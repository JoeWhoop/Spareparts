...
<div class="container">
    ...
    <select id="stationDropdown" size="10">
        ...
        <option value="4000182_SWIATELKO_KIEROWNIC">4000182 SWIATEŁKO KIEROWNIC</option>
        ...
        <option value="4001723_KABEL_PRZOD_TROJNIK">4001723 KABEL PRZÓD TRÓJNIK</option>
